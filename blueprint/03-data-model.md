...
- A kiosk policy's `restrictions_json` carries the cleartext kiosk exit passcode for admin visibility; the server hashes it into the signed device snapshot for kiosk recovery.
