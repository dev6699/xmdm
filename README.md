...
Note: `M6-01 Kiosk Enforcement` now also supports a policy-defined kiosk app package, explicitly releases the launcher before handing off to the kiosk app, and keeps the temporary `exit_kiosk` command path as of 2026-05-01, while keeping the kiosk enforcement item marked complete.
